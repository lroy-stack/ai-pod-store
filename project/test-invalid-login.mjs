...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: '/Users/lr0y/POD-AI-PDR/pod-agent-harness/pod_workspace/project/invalid-login-form-filled.png', fullPage: true });
    ...
    await page.screenshot({ path: '/Users/lr0y/POD-AI-PDR/pod-agent-harness/pod_workspace/project/invalid-login-error-message.png', fullPage: true });
    ...
    if (errorExists) {
      ...
      const isUserFriendly = errorText && (
      ...
      if (isUserFriendly) {
        ...
        console.log('⚠ Error message might not be user-friendly:', errorText);
      }
    } else {
    ...
    await page.screenshot({ path: '/Users/lr0y/POD-AI-PDR/pod-agent-harness/pod_workspace/project/invalid-login-error.png', fullPage: true });
  } finally {
    await browser.close();
  }
})();
