        ...
        return {
            ...
            "gemini_generate_image": {
                "description": (
                    ...
                    "describe the ARTWORK ONLY. ALWAYS specify 'white background' or 'transparent background'. "
                    "Good: 'fierce phoenix rising from orange flames, vector illustration style, white background' "
                    "Bad: 'phoenix t-shirt design' or 'mug with skull artwork'"
                ),
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "prompt": {
                            "type": "string",
                            "description": (
                                "Describe ARTWORK ONLY — never mention product types (t-shirt, mug, hoodie, poster). "
                                "Always include 'white background' or 'transparent background'. "
                                "Describe style, colors, and composition narratively."
                            ),
                        },
                        "aspect_ratio": {
                            "type": "string",
                            "enum": ["1:1", "3:4", "4:3", "9:16", "16:9"],
                            "description": "Aspect ratio (default: 1:1 for products)",
                        },
                        "image_size": {
                            "type": "string",
                            "enum": ["1K", "2K"],
                            "description": "Resolution: 1K (1024px, default) or 2K (2048px, better for print)",
                        },
                    },
                    "required": ["prompt"],
                },
            ...
            "gemini_check_image": {
                "description": (
                    ...
                    "MUST be called on EVERY image (sourced or generated) before Printify upload."
                ),
                "input_schema": {
                    "type": "object",
                    "properties": {
