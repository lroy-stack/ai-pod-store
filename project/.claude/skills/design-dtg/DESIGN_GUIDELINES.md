# SKAPARA Design Guidelines — Based on Real Product Designs

## Brand Identity

**SKAPARA** — European POD tech merch. Minimalist, text-heavy, AI/dev humor, premium feel. Público: tech professionals europeos con dinero, un poco freaky. Streetwear + Silicon Valley, diseñado en EU.
...
El patrón MÁS usado en SKAPARA. Estructura de "setup + punchline":
...
- Más complejo que Patrón A pero mantiene el minimalismo SKAPARA
...
Composición S mark + wordmark "SKAPARA" adaptada al canvas de cada producto.
...
|---|---|---|---|
| `branded-previews/01-skapara-noir-mug.png` | Noir | Horizontal | 2244×945 (mug BP1018) |
| `branded-previews/02-skapara-signal-bottle.png` | Noir | Horizontal | 2759×1500 (bottle BP854) |
| `branded-previews/03-skapara-core-crewneck.png` | White | Vertical | 3366×4230 (crew BP457) |
| `branded-previews/04-skapara-edge-longsleeve.png` | White | Vertical, upper-left | 4110×4658 (LS BP80) |
| `branded-previews/05-skapara-grip-deskmat.png` | Pattern B&W | Tiled diagonal | 7205×3661 (desk BP969) |
| `branded-previews/06-skapara-step-sneaker-*.png` | White | Small, positioned | 1433×649 per area |
| `branded-previews/07-skapara-pack-sticker.png` | Full Gradient | Mark only (die-cut) | 4500×4500 (sticker BP476) |
...
- [ ] Colores de la paleta real SKAPARA (NO azul, NO múltiples acentos)
