# SOL'S 03567 Organic Raglan Sweatshirt Embroidery Variant Reference — Catalog 582

## Summary

| Property | Value |
|---|---|
| **Catalog ID** | 582 (same as DTG/DTFilm) |
...
|---|---|---|---|---|
| XS | TBD-API-QUERY | 26.20 | +8.85 | 35.05 |
| S | TBD-API-QUERY | 26.20 | +8.85 | 35.05 |
| M | TBD-API-QUERY | 26.20 | +8.85 | 35.05 |
| L | TBD-API-QUERY | 26.20 | +8.85 | 35.05 |
| XL | TBD-API-QUERY | 28.55 | +8.85 | 37.40 |
| 2XL | TBD-API-QUERY | 30.70 | +8.85 | 39.55 |
| 3XL | TBD-API-QUERY | 32.95 | +8.85 | 41.80 |
...
| Burnt Orange | `burnt-orange` | MEDIUM | White, Black — test thread contrast with both |
