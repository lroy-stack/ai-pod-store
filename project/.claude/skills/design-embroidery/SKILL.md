...
1. **White only** on dark cap — cleanest, cheapest, most SKAPARA
...
- **Text logos**: "SKAPARA", short phrases (2-4 words MAX)
...
- **Back**: Small S mark or "skapara.com" text (1 thread color, white on dark caps)
...
1. **Front = main design**, sides/back = SKAPARA branding accent
...
**Recommended colors for SKAPARA headwear** (dark-first brand):
...
- **Exception**: Brand embroidery (SKAPARA wordmark) is always text — see branded examples

**For branded embroidered hats:**
- S mark or "SKAPARA" wordmark in 1-2 thread colors (white on dark, navy on light)
