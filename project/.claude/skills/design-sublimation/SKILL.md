...
1. **Wrap products benefit from SKAPARA gradient** — sublimation handles gradients beautifully
...
- Example (sticker): "Die-cut SKAPARA mark in full gradient. Stick it on your laptop, water bottle, or that one meeting room whiteboard nobody cleans."
...
|---|---|---|---|
| `branded-previews/01-skapara-noir-mug.png` | Mug 11oz BP1018 | 2244×945 | Navy S mark + wordmark, horizontal lockup, white bg |
| `branded-previews/02-skapara-signal-bottle.png` | Bottle BP854 | 2759×1500 | Navy S mark + wordmark, horizontal lockup |
| `branded-previews/05-skapara-grip-deskmat.png` | Desk Mat BP969 | 7205×3661 | Repeating S mark pattern, B&W tiled diagonal |
| `branded-previews/06-skapara-step-sneaker-*.png` | Sneaker BP767 | 1433×649/area | White S mark + wordmark (body), S mark only (tongue) |
| `branded-previews/07-skapara-pack-sticker.png` | Sticker BP476 | 4500×4500 | S mark with FULL gradient fill, die-cut |
...
2. **Sticker**: ONLY product using full SKAPARA gradient — S mark die-cut
...
- Stickers = only die-cut product using full SKAPARA gradient
