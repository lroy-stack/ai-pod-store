...
export function DesignEditorClient({ product, variants, designTemplates, compositionId }: DesignEditorClientProps) {
  return <DesignStudioPage product={product} variants={variants} designTemplates={designTemplates} compositionId={compositionId} />
}
