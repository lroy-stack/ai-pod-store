    ...
    <div className="space-y-2 p-3">
      ...
      {selectedObject && (
        <div className="flex gap-1">
          <Button variant="outline" size="icon" className="size-7" onClick={onBringToFront} title={t('bringToFront')}>
            <ChevronsUp className="size-3.5" />
          </Button>
          <Button variant="outline" size="icon" className="size-7" onClick={onBringForward} title={t('bringForward')}>
            <ChevronUp className="size-3.5" />
          </Button>
          <Button variant="outline" size="icon" className="size-7" onClick={onSendBackward} title={t('sendBackward')}>
            <ChevronDown className="size-3.5" />
          </Button>
          <Button variant="outline" size="icon" className="size-7" onClick={onSendToBack} title={t('sendToBack')}>
